...
namespace WoWonder.Activities.Chat.MsgTabbes.Fragment
{
    public class FilterLastChatDialogFragment : BottomSheetDialogFragment, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        private MsgTabbedMainActivity ContextMain;
        ...
        private void InitComponent(View view)
        {
            try
            {
                ...
                FontUtils.SetTextViewIcon(FontsIconFrameWork.IonIcons, TypeMoreIcon, AppSettings.FlowDirectionRightToLeft ? IonIconsFonts.IosArrowDropleft : IonIconsFonts.IosArrowDropright);
        ...
        private void LayoutTypeOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                arrayAdapter.Add(Context.GetString(Resource.String.Lbl_Users));
                arrayAdapter.Add(Context.GetString(Resource.String.Lbl_Group));
                arrayAdapter.Add(Context.GetString(Resource.String.Lbl_Pages));
        ...
        public void OnSelection(MaterialDialog p0, View p1, int itemId, ICharSequence itemString)
        {
            try
            {
                ...
                else if (text == Context.GetString(Resource.String.Lbl_Users))
                {
                    Type = "users";
                }
                ...
                else if (text == Context.GetString(Resource.String.Lbl_Pages))
                {
                    Type = "pages";
                }
