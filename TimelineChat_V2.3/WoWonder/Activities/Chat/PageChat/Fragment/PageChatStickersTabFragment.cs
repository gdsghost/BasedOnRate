...
{
    public class PageChatStickersTabFragment : AndroidX.Fragment.App.Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            try
            {
                View view = inflater.Inflate(Resource.Layout.Chat_StickersTab_Fragment, container, false); 
                return view;
            }
            catch (Exception e)
            {
