...
namespace WoWonder.Activities.Comment
{
    ...
    public class ReplyCommentActivity : BaseActivity
    {
        ...
        public static CommentAdapterViewHolder ReplyCommentObject;
        ...
        protected override void OnDestroy()
        {
            try
            {
                if (ReplyCommentObject != null)
                {
                    ReplyCommentObject.CountRating.Text = CommentObject.Reaction.Count + " User Rated";
                    ReplyCommentObject.RatingBar.Rating = (float)Convert.ToDouble(CommentObject.Reaction.Type);
                    ReplyCommentObject.RatingText.Text = CommentObject.Reaction.Type;
                }
