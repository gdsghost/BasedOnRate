...
namespace WoWonder.Activities.Live.Page 
{
    ...
    {
        private static int BeautyEffectDefaultContrast = DT.Xamarin.Agora.Video.BeautyOptions.LighteningContrastNormal;
        private static float BeautyEffectDefaultLightness = 0.7f;
        private static float BeautyEffectDefaultSmoothness = 0.5f;
        private static float BeautyEffectDefaultRedness = 0.1f;
