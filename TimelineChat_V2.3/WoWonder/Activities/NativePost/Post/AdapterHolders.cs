            ...
            public void OnClick(View v)
            {
                try
                {
                    if (AdapterPosition != RecyclerView.NoPosition)
                    {
                        ...
                        if (v.Id == RatingLinearLayout.Id)
                            PostClickListener.RatePostClickAsync(new GlobalClickEventArgs { NewsFeedClass = item, Position = AdapterPosition, View = MainView }, PostAdapter);
