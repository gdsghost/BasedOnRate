        ...
        public override void OnViewRecycled(Object holder)
        {
            try
            {
                ...
                if (holder != null)
                {
                    ...
                    else if (holder is AdapterHolders.PostAddCommentSectionViewHolder viewHolder20)
                        Glide.With(ActivityContext).Clear(viewHolder20.ProfileImageView);
                    else if (holder is CommentAdapterViewHolder viewHolder21)
                    {
                        if (viewHolder21.CommentImage != null)
                            Glide.With(ActivityContext).Clear(viewHolder21.CommentImage);
                    }

                    else if (holder is AdapterHolders.PostTopSharedSectionViewHolder viewHolder22)
                        Glide.With(ActivityContext).Clear(viewHolder22.UserAvatar);
                    else if (holder is AdapterHolders.PostPrevBottomSectionViewHolder viewHolder23)
                        Glide.With(ActivityContext).Clear(viewHolder23.ImageCountLike);
                    else if (holder is AdapterHolders.JobPostViewHolder1 viewHolder24)
                    {
